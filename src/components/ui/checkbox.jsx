...
const Checkbox = React.forwardRef(({ className, checked, indeterminate, ...props }, ref) => {
  ...
  return (
    <CheckboxPrimitive.Root
      ...
      className={cn(
        'peer h-4 w-4 shrink-0 rounded border border-[hsl(var(--border))] ring-offset-[hsl(var(--background))] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(var(--ring))] focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50',
